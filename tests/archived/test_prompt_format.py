...
def test_prompt_format():
    ...
    print(f"• Оценка Soft Skills - анализ надпрофессиональных компетенций (10 вопросов по 5-балльной шкале). Наиболее развитый навык: {max_soft} ({test_results['soft_skills'][max_soft]} баллов)")
