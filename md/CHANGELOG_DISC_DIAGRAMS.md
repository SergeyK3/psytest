...
1. Квадратная форма круговой диаграммы
1. Оптимальная ширина столбиковой диаграммы
1. Читаемые черные нежирные шрифты
1. Минимальные расстояния между элементами
1. Структурная квадратная рамка
1. Месячная организация файлов в Google Drive
