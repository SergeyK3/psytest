...
1. **Оптимизация использования страниц** - подготовка к перераспределению контента
1. **Уменьшение размера шрифта SOFT SKILLS** - улучшение компактности диаграмм
...
1. `src/psytest/charts.py` - функция make_radar_chart_soft_skills
