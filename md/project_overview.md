...
1. **Обработка результатов** с помощью AI
1. **Генерация PDF** с диаграммами и интерпретациями
1. **Автосохранение в Google Drive** с месячной структурой папок
1. **Предоставление ссылки** для просмотра и скачивания
